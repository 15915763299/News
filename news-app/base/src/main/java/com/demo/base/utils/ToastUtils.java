...
public final class ToastUtils {
    ...
    private static void show(final int resId, final int duration) {
        try {
            CharSequence text = BaseApp.app.getResources().getText(resId);
            show(text, duration);
    ...
    private static void show(final CharSequence text, final int duration) {
        Utils.runOnUiThread(new Runnable() {
            ...
            public void run() {
                cancel();
                iToast = ToastFactory.makeToast(BaseApp.app, text, duration);
    ...
    private static void show(final View view, final int duration) {
        Utils.runOnUiThread(() -> {
            cancel();
            iToast = ToastFactory.newToast(BaseApp.app);
            iToast.setView(view);
    ...
    private static View getView(@LayoutRes final int layoutId) {
        LayoutInflater inflate =
                (LayoutInflater) BaseApp.app.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    ...
    static class ToastWithoutNotification extends AbsToast {
        ...
        private static final ActivityLifecycleUtil.OnActivityDestroyedListener LISTENER =
                new ActivityLifecycleUtil.OnActivityDestroyedListener() {
                    @Override
        ...
        private void realShow() {
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N_MR1) {
                ...
                Context topActivityOrApp = ActivityLifecycleUtil.getTopActivityOrApp();
                ...
                ActivityLifecycleUtil.getLifecycle().addOnActivityDestroyedListener(topActivity, LISTENER);
            }
            ...
            mParams.packageName = BaseApp.app.getPackageName();
