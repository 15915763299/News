...
import com.demo.c.user.processer.IActionProcessor;
import com.demo.c.user.processer.PLogin;
 ...
 */
public class UserComponent implements IComponent, IMainThread {
    ...
    public Boolean shouldActionRunOnMainThread(String actionName, CC cc) {
        if (PLogin.PROCESSOR_NAME.equals(actionName)) {
            return true;
        }
        return null;
    }
